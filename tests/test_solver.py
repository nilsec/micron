...
class TestEdgeIsolatedNotSolved(unittest.TestCase):
    def setUp(self):
        # y: 1|   0(s)--1(s)--2(s)
        #    2|
        #    3|   3(s)--4(ns)
        ...
        self.nodes = [
                ...
                {'id': 2, 'z': 1, 'y': 1, 'x': 3, 'selected': True, 'solved': True},
                {'id': 3, 'z': 1, 'y': 3, 'x': 1, 'selected': True, 'solved': True},
                {'id': 4, 'z': 1, 'y': 4, 'x': 1, 'selected': False, 'solved': False}
    ...
    def test_constraints(self):
        ...
        #self.assertTrue(len(solver.v_selected) == 0)
        # 1 isolated edge:
        print("V SELECTED EDGE NS", solver.v_selected)
        print("E SELECTED EDGE NS: ", solver.e_selected)
        print("TRIPLETS EDGE NS: ", solver.triplets)
    ...
    def test_solve(self):
        ...
        print("EDGE NS SELECTED EDGES:", selected_edges)
        print("EDGE NS SELECTED NODES:", selected_nodes)

        self.assertTrue(len(selected_edges) == len(self.edges))
        self.assertTrue(len(selected_nodes) == len(self.nodes))


class TestEdgeIsolatedPartiallySolved(unittest.TestCase):
    def setUp(self):
        # y: 1|   0(s)--1(s)--2(s)
        #    2|
        #    3|   3(s)--4(ns)
...
class TestDropConstraints(unittest.TestCase):
    def setUp(self):
        # y: 1|   0(s)--1(s)--2(s)
        #    2|
        #    3|   3(s)--4(s)--5(s)
        ...
        self.nodes = [
                ...
                {'id': 5, 'z': 1, 'y': 3, 'x': 3, 'selected': True, 'solved': True},
                {'id': 6, 'z': 1, 'y': 4, 'x': 2, 'selected': True, 'solved': True}
        ...
        self.edges = [{'u': 0, 'v': 1, 'evidence': 0.5, 'selected': True, 'solved': True},
                      ...
                      {'u': 4, 'v': 6, 'evidence': 0.5, 'selected': False, 'solved': True},
...
class TestTwoIsolatedNS(unittest.TestCase):
    def setUp(self):
        # y: 1|   0(s)--1(s)--2(s)
        #    2|
        #    3|   3(ns)--4(ns)
        ...
        self.edges = [{'u': 0, 'v': 1, 'evidence': 0.5, 'selected': True, 'solved': True},
                      {'u': 1, 'v': 2, 'evidence': 0.5, 'selected': True, 'solved': True},
                      {'u': 1, 'v': 2, 'evidence': 0.5, 'selected': False, 'solved': True},
                      ]
